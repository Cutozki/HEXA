...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ᴄʜᴀɴɴᴇʟ', ur='https://t.me/+4LKOeMy0-mhjNTZl'),
            InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇs', url='https://t.me/+4LKOeMy0-mhjNTZl')
            ],[      
            InlineKeyboardButton('ʜᴇʟᴘ⚙️', callback_data='help'),
            InlineKeyboardButton('ᴀʙᴏᴜᴛ', callback_data='about')
            ],[
            InlineKeyboardButton('ᴡᴇʙsɪᴛᴇ', url='www.Hollyflix.ml')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ᴍᴏᴠɪᴇ ᴡᴇʙsɪᴛᴇ', callback_data='deploy')
            ],[
        ...
        buttons= [[
            InlineKeyboardButton('♥️ 𝙳𝙴𝙿𝙻𝙾𝚈 𝚃𝚄𝚃𝙾𝚁𝙸𝙰𝙻 ♥️', url='https://youtu.be/1G1XwEOnxxo')
            ],[
